...
function [ D2, L, B1] = LoadSegment_Btotal_rollingball_MCF7( fname, wavelength, Btotal)
...
% This code 'LoadSegment_Btotal_rollingball_MCF7.m' is copyright 2021
...
% B2 = imagebackground_polyn_reduced2(D-B1,2,50,10);    %compute image background
D1 = D-B1-Btotal;           %subtract background from data files
D2 = imtophat(D1, strel('ball', 110,110)); %40-50 worked well for MDA-MB-231
